...
public class MovementController2D : MonoBehaviour
{
    ...
    [SerializeField] Pathfinder<Vector2> pathfinder; //the pathfinder object that stores the methods and patience
    ...
    [SerializeField] List<Vector2> pathLeftToGo= new List<Vector2>();
